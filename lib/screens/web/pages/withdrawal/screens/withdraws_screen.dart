...
import '../widgets/withdrawal_tab_widget.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text("Withdrawal", style: Theme.of(context).textTheme.labelLarge!.copyWith(fontSize: 35, fontWeight: FontWeight.bold)),
                  ),
                  SizedBox(height: 30),
                  Expanded(
